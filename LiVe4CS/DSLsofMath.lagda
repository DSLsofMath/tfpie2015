...
\addheadbox{section}{\quad \tiny LiVe4CS, 2017-12-05}
\title[DSLsofMath]{DSLsofMath: Presenting Mathematical Analysis Using Functional Programming}

\author[P. Jansson and C. Ionescu]
       {Patrik Jansson          \hspace{2.5cm} Cezar Ionescu      \\
        patrikj@@chalmers.se    \hspace{2cm}   cezar@@chalmers.se }
...
\item use types (|Nat|, |Real|, |CC|) as carriers of semantic information,
  not just variable names (|n|, |x|, |z|)
...
\includegraphics[height=0.9\textheight]{../WG2.1/adams-complete-course-front-page.pdf}%
&\only<2>{\vspace{0cm}\includegraphics[height=0.9\textheight]{../WG2.1/p993_crop.pdf}}
\end{tabular}
...
\begin{myquote}
  ...
  letter; |w| and |z| are frequently used for this purpose.
  %
  If |a|, |b|, |x|, and |y| are real numbers, and |w = a + bi| and |z
  = x + yi|, then we can refer to the complex numbers |w| and
  |z|.
  %
...
\begin{myquote}
  ...
  If |w == a + bi| and |z == x + yi|, where |a|, |b|, |x|, and |y| are
  real numbers, then
